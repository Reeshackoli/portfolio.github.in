...
public:
    void initializeData(Graph& cityGraph)
    {
        locations =
        {
            {0, "Colaba"}, {1, "Nariman Point"}, {2, "Fort"}, {3, "Churchgate"},
            {4, "Breach Candy"}, {5, "Worli"}, {6, "Lower Parel"}, {7, "Dadar"},
            {8, "Vile Parle"}, {9, "Andheri"}, {10, "Bandra"}, {11, "Juhu"},
            {12, "Powai"}, {13, "Kandivali"}, {14, "Borivali"}, {15, "Thane"},
            {16, "Kalyan"}, {17, "Mulund"}, {18, "Ghatkopar"}, {19, "Versova"}
        };

        hospitalSpecialists =
        {
            {0, {"General Practitioner"}}, {1, {"Pediatrics", "ENT"}}, {2, {"Cardiology", "Neurology", "Dermatology"}},
            {3, {"Oncology", "Orthopedics"}}, {4, {"Ophthalmology", "Gynecology", "Cardiology"}},
            {5, {"Neurology", "General Surgery"}}, {6, {"Psychiatry", "Endocrinology"}},
            {7, {"Orthopedics", "Pulmonology"}}, {8, {"Gastroenterology", "Urology"}}, {9, {"Dermatology", "ENT"}},
            {10, {"Pediatrics", "Psychiatry"}}, {11, {"Cardiology", "Orthopedics"}}, {12, {"Neurology", "Gastroenterology"}},
            {13, {"Pulmonology", "Dermatology"}}, {14, {"Orthopedics", "Gynecology"}}, {15, {"Oncology", "Cardiology"}},
            {16, {"Neurology", "Ophthalmology"}}, {17, {"ENT", "Orthopedics"}}, {18, {"Cardiology", "Gastroenterology"}},
    ...
    void displayAllSpecialties()
    {
        ...
        map<int, string> specialties = {
            {1, "General Practitioner"}, {2, "Pediatrics"}, {3, "ENT"},
            {4, "Cardiology"}, {5, "Neurology"}, {6, "Dermatology"},
            {7, "Oncology"}, {8, "Orthopedics"}, {9, "Gynecology"},
            {10, "Psychiatry"}, {11, "Ophthalmology"}, {12, "Pulmonology"},
            {13, "Gastroenterology"}, {14, "Urology"}
        };
    ...
    do {
        ...
        switch (choice) {
            ...
            case 31:
                ...
                break;
            case 32: // Go back to main menu option
                cout << "Returning to the main menu...\n";
                break;
            default:
                cout << "Invalid choice. Please try again.\n";
        }
    } while (choice != 0);  // Loop continues until the user chooses to exit (or "Go Back")
}
